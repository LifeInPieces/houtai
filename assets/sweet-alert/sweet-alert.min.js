...
function (e, t, n) {
    function o(e) {
        ...
        if (O(t.querySelectorAll(".sa-icon")), e.type && !u()) {
            for (var c = !1,
            l = 0; l < h.length; l++) if (e.type === h[l]) {
                c = !0;
                break
            }
            if (!c) return f("Unknown alert type: " + e.type),
            !1;
        ...
        e.animation ? t.setAttribute("data-animation", "pop") : t.setAttribute("data-animation", "none"),
    ...
    D = function (e) {
        ...
        return t = "undefined" != typeof getComputedStyle ? parseInt(getComputedStyle(e).getPropertyValue("padding"), 10) : parseInt(e.currentStyle.padding),
        e.style.left = "",
        e.style.display = "none",
        "-" + parseInt(n / 2 + t) + "px"
    },
    ...
    v = b = function () {
        ...
        function u(t) {
            ...
            if (-1 !== [9, 13, 32, 27].indexOf(a)) {
                for (var r = o.target || o.srcElement,
                s = -1,
                c = 0; c < D.length; c++) if (r === D[c]) {
                    s = c;
                    break
                }
        ...
        var b = arguments[0];
        if (arguments[0] === n) return f("SweetAlert expects at least 1 attribute!"),
        !1;
        var g = r({},
        S);
        switch (typeof arguments[0]) {
            case "string":
                ...
                break;
            case "object":
                if (arguments[0].title === n) return f('Missing "title" argument!'),
                !1;
                ...
                g.confirmButtonText = g.showCancelButton ? "Confirm" : S.confirmButtonText,
                g.confirmButtonText = s("confirmButtonText"),
                g.doneFunction = arguments[1] || null;
                break;
            default:
                return f('Unexpected type of argument! Expected "string" or "object", got ' + typeof arguments[0]),
                !1
        }
        o(g),
        l(),
        ...
        for (var B = x(), E = function (t) {
            ...
            case "focus":
                ...
                break;
            case "click":
                if (r && i && s) g.doneFunction(!0),
                g.closeOnConfirm && v.close();
        else if (i && s) {
                    var u = String(g.doneFunction).replace(/\s/g, ""),
                    f = "function(" === u.substring(0, 9) && ")" !== u.substring(9, 10);
                    f && g.doneFunction(!1),
                    g.closeOnCancel && v.close()
        } else v.close()
        }
        },
        q = B.querySelectorAll("button"), A = 0; A < q.length; A++) q[A].onclick = E,
        q[A].onmouseover = E,
        q[A].onmouseout = E,
        q[A].onmousedown = E,
        q[A].onfocus = E;
        ...
        t.onclick = function (t) {
            ...
            r = M(B, o),
            s = C(B, "visible"),
            i = "true" === B.getAttribute("data-allow-ouside-click"); !a && !r && s && i && v.close()
        };
