$(function () {
    ...
    $("#chickTable").delegate(".draw", "click", function () {
        $(".mengban_over").show()
        $(".add_draw").show()
    ...
    // 修改数据
    $("#chickTable").delegate(".emit", "click", function () {
        // 回显表单数据
        buychickenId = $(this).data("id");
        $.ajax({
    ...
    // 删除数据
    $("#chickTable").delegate(".chick_del", "click", function () {
    ...
    // 点击进入入库明细
    $("#chickTable").delegate(".distribution", "click", function () {
        var buychickenId = $(this).data("id")
        // 品种
        $.ajax({
            url: http + "/buychicken/findById.do",
...
//   图片放大
$("#chickTable").delegate(".images>img", "click", function () {
...
$("#chickTable").delegate(".drawerror", "click", function () {
